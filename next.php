...
if(isset($_POST['submit'])){
    ...
    $sql= "INSERT INTO appointment (fullname,numbers,email,date_of_event) values('$fullname','$numbers','$email','$date_of_event')";
// Create connection
...
<section class="book" id="book">
    ...
    <div class="row">
        ...
        <form action="#" method = "POST">
            ...
            <input type="number" name="numbers" placeholder="your number" class="box">
            <input type="email" name="email" placeholder="your email" class="box">
            <input type="date" name="date_of_event" class="box">
